...
public class SaveNewPaymentMethodAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, 
        ...
        try {
        	...
        	// An archived project takes no new payment methods.
		...
		paymentMethod.setBudgetExpirationDate(pmForm.getBudgetExpirationDate());
        ...
        // send an email 
        try {
        	NewPaymentMethodAddedEmailer.getInstance().sendEmail(paymentMethod, projectId);
        }
        catch(Exception e) {
