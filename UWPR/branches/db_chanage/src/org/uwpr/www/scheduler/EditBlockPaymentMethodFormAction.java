 ...
 * 
 */
public class EditBlockPaymentMethodFormAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, 
        ...
        List<EditBlockPaymentMethodForm.PaymentPercent> paymentPercentList = new ArrayList<EditBlockPaymentMethodForm.PaymentPercent>();
        for(InstrumentUsagePayment paymentMethod: usagePayments)
        {
            EditBlockPaymentMethodForm.PaymentPercent paymentPercent = new EditBlockPaymentMethodForm.PaymentPercent();
        ...
        EditBlockPaymentMethodForm editForm = new EditBlockPaymentMethodForm();
        ...
        request.setAttribute("editBlockPaymentForm", editForm);
