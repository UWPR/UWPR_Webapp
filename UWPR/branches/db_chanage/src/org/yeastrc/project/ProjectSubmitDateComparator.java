/* ProjectSubmitDateComparator.java
 ...
 *
 */
public class ProjectSubmitDateComparator implements Comparator<ComparableProject> {
	...
	public int compare(ComparableProject p1, ComparableProject p2) {
		...
		Date d1 = p1.getSubmitDate();
		Date d2 = p2.getSubmitDate();
