...
<yrcwww:contentbox title="Create a New Researcher">

 <CENTER>
 
<logic:present name="saved" scope="request">
  <P align="center"><B>The researcher was successfully added to the database.</B></P>
</logic:present>


  <div>Fill out this form to enter a new researcher into our database.</div>

  <p><html:form action="saveResearcher" method="post">
  <TABLE CELLPADDING="no" CELLSPACING="0" border="0" width="60%">
