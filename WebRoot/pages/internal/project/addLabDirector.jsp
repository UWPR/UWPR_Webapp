...
<logic:notPresent name="addLabDirectorForm" scope="request">
 <logic:forward name="addLabDirector"/>
</logic:notPresent>
...
<yrcwww:contentbox title="Add Lab Director">
 <CENTER>
  <html:form action="saveLabDirector" method="post">
  
  	Select existing researcher:
  	<html:select property="researcherId">
   		<html:option value="0">None</html:option>
		<html:options collection="researchers" property="ID" labelProperty="listing"/>
   	</html:select>
  
  <div style="font-size:12px; font-weight:bold; margin:10 0 10 0;">OR</div>
  
  Add a new researcher:<br/>
  ...
  <P><html:submit value="Save Lab Director"/>
