...
<yrcwww:contentbox title="Change Your Password">
 
 <CENTER>
 
 	<logic:present name="saved" scope="request">
 		<P align="center"><B>Your password was successfully updated.</B></P>
	</logic:present>


 	<div>To change your password, fill out this form.  Passwords are limited to 20 characters.</div>
